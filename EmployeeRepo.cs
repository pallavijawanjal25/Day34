...
namespace EmployeePayRoll_ADO.NET
{
   public class EmployeeRepo
    {
        public static string connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Demo184;Integrated Security=True";
        ...
        public void GetAllEmployee()
        {
            try
            {
                ...
                {
                    string query = @"SELECT EmployeeID,Employee,PhoneNumber,Address,Department,Gender,BasicPay,Deductions,TaxablePay,Tax,NetPay,StartDate,City,Country
                    ...
                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            ...
                            employeeModel.Employee = dr.GetString(1);
                            ...
                            Console.WriteLine("{0},{1},{2},{3},{4},{5},{6}", employeeModel.EmployeeID, employeeModel.Employee, employeeModel.PhoneNumber, employeeModel.Address, employeeModel.Department, employeeModel.Gender, employeeModel.BasicPay);
                            Console.WriteLine("\n");
                        }
                    }
                    else
        ...
        {
            string query = @"Update Employee_payroll Set BasicPay=3000000.00 Where Employee='Terisa'";
            SqlCommand cmd = new SqlCommand(query, this.connection);
            this.connection.Open();
            SqlDataReader dr = cmd.ExecuteReader();
            EmployeeModel employeeModel = new EmployeeModel();
                ...
                using (this.connection)
                {
                    ...
                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            ...
                            employeeModel.Employee= dr.GetString(0);
                            ...
                            Console.WriteLine("{0},{1},{2},{3},{4},{5}", employeeModel.Employee, employeeModel.BasicPay, employeeModel.Deductions, employeeModel.TaxablePay, employeeModel.Tax, employeeModel.NetPay);
                        }
                    }
                    else
                    {
